...
public final class ItemRegistry {
    ...
    public static void init() {
        ...
        registerItem("feather_meal", new FertilizerItem(new FabricItemSettings().group(CROPTOSIS)));
        registerItem("rotten_pile", new FertilizerItem(new FabricItemSettings().group(CROPTOSIS)));
        registerItem("apatite", new FertilizerItem(new FabricItemSettings().group(CROPTOSIS)));
        registerItem("potash", new FertilizerItem(new FabricItemSettings().group(CROPTOSIS)));
