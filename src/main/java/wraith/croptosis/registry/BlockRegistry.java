...
public class BlockRegistry {
    ...
    public static final HashMap<String, Block> BLOCKS = new HashMap<String, Block>(){{
        ...
        put("potash_ore", new CustomOreBlock(AbstractBlock.Settings.of(Material.STONE).requiresTool().strength(3.0F, 3.0F)));
        put("apatite_ore", new CustomOreBlock(AbstractBlock.Settings.of(Material.STONE).requiresTool().strength(3.0F, 3.0F)));
    }};
